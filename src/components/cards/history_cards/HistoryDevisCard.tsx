        ...
        <View style={styles.container}>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
                ...
                <View style={{ flexDirection: "row", alignItems: "center", gap: 5 }}>
                    ...
                    <Text>{(facture?.status === "REJECT") ? "Devis rejeté" : facture?.status === "PENDING" ? "En attente de validation" : (facture?.status === "VALIDATED" && facture?.paymentStatus !== "PAID") ? "Devis validé" : facture?.paymentStatus === "PAID" && "Devis payé"}</Text>
                </View>

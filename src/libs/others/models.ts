...
interface IStore { user_loading: boolean, errors: string | null, user: IRegisterRes | null, auth: ILoginRes | null, temp: boolean, temps: boolean, code: { id: string, pin: number }, username?: string | null }
...
interface IFactureStore { ok: "", facture_loading: boolean, errors: string | null, facture: IFactureReq | null, factures: IFactureReq[], tmp: boolean }
...
interface IISAGOstore { ok: "", isago_loading: boolean, errors: string | null, isago: IISAGOreq | null, isagos: IISAGOreq[], tmp: boolean }

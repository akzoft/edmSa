...
interface IStore { u_loading: boolean, errors: string | null, user: IRegisterRes | null, auth: ILoginRes | null, temp: boolean, code: { id: string, pin: number }, username?: string | null }

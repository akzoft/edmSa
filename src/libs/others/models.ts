...
interface IStore { u_loading: boolean, errors: string | null, user: IRegisterRes | null, auth: ILoginRes | null, temp: boolean, temps: boolean, code: { id: string, pin: number }, username?: string | null }
...
interface IDevisStore { ok?: string, s_loading: boolean, errors: string | null | undefined, devi: IDevisReq | null, devis: IDevisReq[], tmp: boolean }
...
interface IVillestore { loading: boolean, errors: string | null, villes: IVille[] }
...
interface IFactureStore { ok: "", loading: boolean, errors: string | null, facture: IFactureReq | null, factures: IFactureReq[], tmp: boolean }

interface IISAGOsearch { compteur: string | undefined, customerId: string | undefined, }
interface IISAGOreq { compteur: string, owner: string, address: string, customerCode: string, amount: number, phone: number, customerId: string, }
...
interface IISAGOstore { ok: "", loading: boolean, errors: string | null, isago: IISAGOreq | null, isagos: IISAGOreq[], tmp: boolean }
...
export type {
    ...
    IInfoRes, IActualiteStore, IActualite, IDevisReq, ICompteur, ICompteurStore, TCompteurType
}
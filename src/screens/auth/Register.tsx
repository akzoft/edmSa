                ...
                <View style={css.auth.container}>
                    ...
                    <View style={css.auth.forms}>
                        ...
                        <View style={css.auth.form_item}>
                            <TextInput style={css.auth.input} placeholder='Nom complet*' value={inputs.name.toString()} onChangeText={(text) => handleChangeMobile("name", text, setInputs)} />
                        </View>
                        <View style={css.auth.form_item}>
                            <TextInput style={css.auth.input} placeholder="Nom d'utilisateur*" value={inputs.username.toString()} onChangeText={(text) => handleChangeMobile("username", text, setInputs)} />
                        </View>
                        <View style={css.auth.form_item}>
                            <TextInput style={css.auth.input} placeholder='Email (Optionnel)' value={inputs.email ? inputs.email.toString() : ""} onChangeText={(text) => handleChangeMobile("email", text, setInputs)} />
                        </View>
                        <View style={css.auth.form_item}>
                            <TextInput style={css.auth.input} keyboardType="phone-pad" placeholder='Numéro de téléphone*' value={inputs.phone.toString()} onChangeText={(text) => handleChangeMobile("phone", text, setInputs)} />
                        </View>
                        <View style={css.auth.form_item}>
                            <TextInput style={css.auth.input} secureTextEntry={true} placeholder='Mot de passe*' value={inputs.password.toString()} onChangeText={(text) => handleChangeMobile("password", text, setInputs)} />
                        </View>
                        ...
                        <TouchableOpacity onPress={handleRegister} style={css.auth.button}>
                            ...
                            {!loading && <Text style={{ color: colors.white, fontWeight: "bold" }}>S'inscrire</Text>}
                        </TouchableOpacity>
